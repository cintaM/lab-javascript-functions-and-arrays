...
function findLongestWord(wordListFind) {
  ...
  for(let possibleWord = 0; possibleWord < wordListFind.length; possibleWord++){
...
function sumNumbers(sumarNumero) {
  let sum = 0;
  
  for (let i = 0; i < sumarNumero.length; i++) {
      sum += sumarNumero[i];
  }
    return sum
...
function averageNumbers(sumarNumero) {

    let sum = 0;
    let arrayNumero = sumarNumero.length
...
function averageWordLength(sumarList) { 
  let sum = 0;
  let arrayPalabras = sumarList.length;
  let i = "";
  let listadoSuma = sumarList[i].length;

   
      for (let i = 0; i < arrayPalabras; i++) {
          sum += listadoSuma;
      }
        return sum / listadoSuma;
    }
